...
const DashboardHome = () => {
  ...
  return (
    <div className="space-y-6 md:space-y-10 p-4 md:p-0">
      {/* 🟢 Welcome Header - Responsive Flex */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
        <div>
          ...
          <p className="text-slate-500 font-medium mt-2 text-sm md:text-base">
            Manage your requirements and AI matches
          </p>
        </div>
        <button 
      ...
      {/* 🟠 Stats Cards - Grid Layout Change */}
                ...
                <div className="flex items-center gap-4 md:gap-6 w-full sm:w-auto">
                   ...
                   <div className="min-w-0 flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                      ...
                      {p.tags.length > 3 && <span className="text-[8px] text-slate-400 font-bold">+{p.tags.length - 3}</span>}
                    </div>
                  </div>
                </div>
